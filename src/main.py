...
# groups of keywords - as they have been saved in mongo 
keywords = [
...
# map keywords to poverty dimensions
POVERTY_DIMENSIONS = {
    'Income': ['crisis', 'desempleo', 'pobreza'],
    'Health': ['enfermedad', 'centro de salud'],
    'Education': ['becas', 'escuela secundaria'],
    'Social_Security': ['pensiones', 'seguro social'],
    'Food': ['ayuda alimentaria', 'banco de alimentos', 'comedor comunitario', 'comida barata', 
             'receta pobre', 'tianguis', 'tiendeo', 'PromoDescuentos'],
    'Housing': ['apoyo Infonavit', 'ayuda renta', 'renta barata', 'servicios en la vivienda', 
                'vivienda del gobierno', 'agua potable', 'FOVISSSTE'],
    'Social_Cohesion': ['violencia', 'conflictos', 'discriminación']}

# create a unique, flat list of all keywords across all poverty dimensions
ALL_KEYWORDS = []
...
# from the timeseries - which go from 2004 onwards - extract only the year
...
# after computing the avrages for each word, we aggregate words that belong to the same dimension and calculate its average 
